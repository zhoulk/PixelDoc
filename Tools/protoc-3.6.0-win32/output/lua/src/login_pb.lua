...
LOGINREQUEST_ID_FIELD.full_name = ".msg.LoginRequest.id"
...
LOGINREQUEST_NAME_FIELD.full_name = ".msg.LoginRequest.name"
...
LOGINREQUEST_EMAIL_FIELD.full_name = ".msg.LoginRequest.email"
...
LOGINRESPONSE_ID_FIELD.full_name = ".msg.LoginResponse.id"
